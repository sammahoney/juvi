...
class Mage_Catalog_Block_Product_View_Type_Configurable extends Mage_Catalog_Block_Product_View_Abstract
{
    ...
    {
        // check OoS display value (admin > config > inventory > stock options > display out of stock products) - from here https://magento.stackexchange.com/questions/62749/showing-out-of-stock-variantssimple-when-all-variants-are-out-of-stock?rq=1
