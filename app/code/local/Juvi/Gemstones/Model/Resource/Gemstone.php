 ...
 */
/**
 * Gemstone resource model
 *
 * @category    Juvi
 * @package     Juvi_Gemstones
 * @author      Ultimate Module Creator
 */
class Juvi_Gemstones_Model_Resource_Gemstone extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    {
        $this->_init('juvi_gemstones/gemstone', 'entity_id');
    }
     ...
     * @access protected
     * @param $object
     * @return Juvi_Gemstones_Model_Resource_Gemstone
     * @author Ultimate Module Creator
     */
