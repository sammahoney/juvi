 ...
 */
/**
 * Press Article resource model
 *
 * @category    Juvi
 * @package     Juvi_Press
 * @author      Ultimate Module Creator
 */
class Juvi_Press_Model_Resource_Pressarticle extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    {
        $this->_init('juvi_press/pressarticle', 'entity_id');
    }
     ...
     * @access protected
     * @param $object
     * @return Juvi_Press_Model_Resource_Pressarticle
     * @author Ultimate Module Creator
     */
    protected function _beforeSave(Mage_Core_Model_Abstract $object)
    {
        ...
        if ($urlKey == '') {
            $urlKey = $object->getPressArticleTitle();
        }
